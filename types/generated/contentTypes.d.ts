...
export interface ApiAloqaAloqa extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    google_maps: Schema.Attribute.Text & Schema.Attribute.Required;
...
export interface ApiElonlarElonlar extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: "E'lonlar";
    pluralName: 'elonlars';
    singularName: 'elonlar';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHamkorlarHamkorlar extends Struct.CollectionTypeSchema {
  collectionName: 'hamkorlars';
  info: {
    displayName: 'Hamkorlar';
    pluralName: 'hamkorlars';
    singularName: 'hamkorlar';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiJurnalHaqidaJurnalHaqida extends Struct.SingleTypeSchema {
  collectionName: 'jurnal_haqidas';
  info: {
    displayName: 'Jurnal haqida';
    pluralName: 'jurnal-haqidas';
    singularName: 'jurnal-haqida';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::jurnal-haqida.jurnal-haqida'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiJurnallarJurnallar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Annotatsiya: Schema.Attribute.Text & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    google_scholar: Schema.Attribute.Text;
    Kalit_suzlar: Schema.Attribute.Text & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTadbirlarTadbirlar extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Tadbirlar';
    pluralName: 'tadbirlars';
    singularName: 'tadbirlar';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    Rasmi: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiTahrirHayatiTahrirHayati
  extends Struct.CollectionTypeSchema {
  collectionName: 'tahrir_hayatis';
  info: {
    displayName: "Tahrir Hay'ati";
    pluralName: 'tahrir-hayatis';
    singularName: 'tahrir-hayati';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tahrir-hayati.tahrir-hayati'
    >;
    publishedAt: Schema.Attribute.DateTime;
    Rasmi: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required &
...
export interface ApiTahririyatXodimlariTahririyatXodimlari
  extends Struct.CollectionTypeSchema {
  collectionName: 'tahririyat_xodimlaris';
  info: {
    displayName: 'Tahririyat Xodimlari';
    pluralName: 'tahririyat-xodimlaris';
    singularName: 'tahririyat-xodimlari';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    Lavozimi: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tahririyat-xodimlari.tahririyat-xodimlari'
    >;
    publishedAt: Schema.Attribute.DateTime;
    Rasmi: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required &
...
export interface ApiYangiliklarYangiliklar extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Yangiliklar';
    pluralName: 'yangiliklars';
    singularName: 'yangiliklar';
  };
  options: {
    draftAndPublish: true;
  };
